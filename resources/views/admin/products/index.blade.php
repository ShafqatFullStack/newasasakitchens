    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <h3 class="box-title m-b-0">Manage Products</h3>
                <p class="text-muted m-b-30">Products List</p>
                <div class="table-responsive">
                    <form action="{{url('admin/delete-selected-products')}}" method="post" id="uform">
...
@section('scripts')
    <script type="text/javascript">
            ...
            swal({
                    ...
                    function(){
                        var APP_URL = {!! json_encode(url('/')) !!}
                                ...
                                window.location.href = APP_URL+"/admin/products/delete/"+id;
                    });
        ...
        function del_selected(){
            swal({
                ...
                $("#uform").submit();
                setTimeout(function () {
                    swal("Products deleted sucessfully. Thanks");
                }, 2000);
            });
        }
    </script>
    ...
    <script>
        ...
        var users = $('#dt_table').DataTable( {
            ...
            "responsive": true,
            "ajax": {
                "url":"{{ route('admin-getAddedProducts') }}",
                "dataType":"json",
                "type":"POST",
    ...
    <script>
        function viewInfo(id) {
            ...
            $.post("{{ route('admin-getProducts') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
