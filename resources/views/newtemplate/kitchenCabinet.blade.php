        ...
        <div class="container" style="margin-top:20px;margin-bottom:20px;text-align:center">
            <div class="row">
                <div class="col d-flex flex-row justify-content-between">
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('homestars.png') }}" width=200 height=200>
                    </div>
                    <div class="col-md-3">
                        <img src="{{ asset('googleVerfied.png') }}" width=200 height=200>
                    </div>
                    <div class="col-md-3">
                        <img src="{{ asset('houzz.png') }}" width=200 height=200>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="shuffle-btn-group">
                            ...
                            <label for="commercial">
                                <input type="radio" name="shuffle-filter" id="commercial" checked="checked"
