        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    {{ Form::model($post, ['method' => 'PATCH','route' => ['services.update', $post->id],'class'=>'form-horizontal generalForm','enctype'=>'multipart/form-data'])}}
                    <div class="col-md-offset-3 col-md-6">
                        ...
                        <div class="form-group ">
                            ...
                            <select name="category" class="form-control" id="">
                                <option value="1" @if($post->category == 1) selected @endif>Commercial</option>
                                <option value="2" @if($post->category == 2) selected @endif>Residential</option>
                            </select>
                        </div>
                        <div class="form-group ">
                            {!! Form::label('Question:') !!}
