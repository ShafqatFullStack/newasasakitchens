...
@php
    $section = \App\Section::findOrFail(4);
            ...
            <div class="picframe">
                <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Hardwood</span>
                                </span>
                            </span>
                </a>
                <img src="{{asset("Hardwood.png")}}" alt="" />
            </div>
        ...
        <div class="item">
            <div class="picframe">
                <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Laminate Flooring</span>
                                </span>
                            </span>
                </a>

                <img src="{{asset("Laminate Flooring.png")}}" alt="" />
            </div>
        </div>
        <!-- close gallery item -->
        ...
        <div class="item">
            <div class="picframe">
                <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Tiles</span>
                                </span>
                            </span>
                </a>

                <img src="{{asset("Tiles.png")}}" alt="" />
            </div>
        </div>
        <!-- close gallery item -->
        ...
        <div class="item">
            <div class="picframe">
                <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Vinyl</span>
                                </span>
                            </span>
                </a>

                <img src="{{asset("Vinyl.png")}}" alt="" />
            </div>
        </div>
        <!-- close gallery item -->
