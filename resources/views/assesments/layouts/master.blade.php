...
<div id="wrapper">
    <header class="header-custom s2">
        ...
        <div class="container">
            <div class="row align-items-center" style="display: flex;background-size: cover;justify-content: flex-end;">

                <div class="col-lg-3 col-md-12 lg-hide">
                    <!-- logo begin -->
                    <div id="logo">
                        <a href="{{route("home")}}">
                    ...
                    <div class="col-md-12">
                        ...
                        <nav>
                            ...
                            <ul id="mainmenu">
                                ...
                                <li><div id="logo" style="margin-top:-9px;">
                        <a href="{{route("home")}}">
                            <img class="logo" src="@isset($setting['admin_logo']) {{ asset('uploads/'.$setting['admin_logo']) }}@endisset" alt="">
                        </a>
                    </div>
