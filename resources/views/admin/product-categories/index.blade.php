    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <a class="btn btn-success pull-right" href="{{route('product-categories.create')}}">
                    <i class="fa fa-plus"></i> Add New
                </a>
                <h3 class="box-title m-b-0">Manage Categories</h3>
                <p class="text-muted m-b-30">Categories List</p>
                <div class="table-responsive">
                    <form action="{{url('admin/delete-selected-product-categories')}}" method="post" id="uform">
...
@section('scripts')
            ...
            swal({
                    ...
                    function(){
                        var APP_URL = {!! json_encode(url('/')) !!}
                                ...
                                window.location.href = APP_URL+"/admin/product-categories/delete/"+id;
                    });
    ...
    <script>
        ...
        var users = $('#dt_table').DataTable( {
            ...
            "responsive": true,
            "ajax": {
                "url":"{{ route('admin-getAddedProductCategories') }}",
                "dataType":"json",
                "type":"POST",
    ...
    <script>
        function viewInfo(id) {
            ...
            $.post("{{ route('admin-getProductCategories') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
