                ...
                <div class="chat">
                    <div class="chat-container">
                        <div class="user-bar">
                            ...
                            <div class="avatar">
                                <img src="{{ asset('uploads/1859343406logo.svg') }}" alt="chat">
                            </div>
                            <div class="name">
                                <span>Alex</span>
                            ...
                            <div class="actions">
                                ...
                                <i class="fa fa-times-circle  pull-right close" aria-hidden="true"></i>
                        ...
                        <div class="conversation">
                            ...
                            <form class="conversation-compose" role="form" action="https://api.whatsapp.com/send"
                                target="_blank">
                                ...
                                <input class="input-msg" name="text" placeholder="Type a message"
...
<a href="javascript:void(0)" id="chatbox"><img src="{{ asset('ecommerce/wb.svg') }}" width="60"
        class="chaticon"></a>
