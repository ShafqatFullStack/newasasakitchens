...
@section("content")
	  ...
	  <section class="hero-wrap hero-wrap-2"  style="background-image:url(../newtemplate/asasa-kitchen/providing/1.png)" >
<div class="overlay"></div>
<div class="container">
<div class="row no-gutters slider-text align-items-end justify-content-start" style="background-size: cover;padding-left: 12px;">
<div class="col-md-12  pb-5" style="margin-top:5%;">
<h1 class="mb-3 bread" style="text-align: left;">{{$work->title}}</h1>
<p class="breadcrumbs"><span class="mr-2"><a href="index-2.html">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="">Projects <i class="fa fa-chevron-right"></i></a></span> <span>{{$work->title}} <i class="fa fa-chevron-right"></i></span></p>
...
<div style="background-color: #fff">
    ...
    <div id="content" class="no-bottom no-top" style="background:white">
