        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title m-b-0">Edit Career -> {{ $career->title }}</h3>
                    {{ Form::model($career, ['method' => 'PATCH','route' => ['careers.update', $career->id],'class'=>'form-horizontal generalForm','enctype'=>'multipart/form-data'])}}
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label">Title</label>
                        <div class="col-sm-7">
                            <input type="text" name="title" class="form-control @error('name') is-invalid @enderror"
                                   required autocomplete="name" value="{{ $career->title }}" autofocus id="name">
                            @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="" cols="30" rows="10">{{ $career->description }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group m-t-15">
                                <img src="{{asset("uploads/works/$career->image")}}" width="150" alt="">
                            </div>
                        </div>
                    </div>
