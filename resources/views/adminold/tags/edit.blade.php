...
<div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="{{ route('tags.index') }}">Manage Tag</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title m-b-0">Edit Tag -> {{ $tag->name }}</h3>
                    {{ Form::model($tag, ['method' => 'PATCH','route' => ['tags.update', $tag->id],'class'=>'form-horizontal generalForm'])}}
