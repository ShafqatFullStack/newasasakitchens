...
@php
    $section = \App\Section::findOrFail(3);
            ...
            <div class="row">
                ...
                <div class="col-md-4 wow fadeIn" data-wow-delay=".25s">
                    <div class="box-number square">
                        ...
                        <div class="text">
                            <h3><span class="id-color justify-content">@isset($storedColumns['title2']) {!! $storedColumns['title2'] !!} @endisset</span></h3>
