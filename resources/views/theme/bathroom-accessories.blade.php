...
@php
    $section = \App\Section::findOrFail(6);
                    ...
                    <div class="picframe">
                        <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Floor Tiles</span>
                                </span>
                            </span>
                        </a>
                        <img src="{{asset("Floor Tiles.png")}}" alt="" />
                    </div>
                ...
                <div class="item">
                    <div class="picframe">
                        <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Freestanding Tub</span>
                                </span>
                            </span>
                        </a>

                        <img src="{{asset("Freestanding Tub.png")}}" alt="" />
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item">
                    <div class="picframe">
                        <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Shower Faucets</span>
                                </span>
                            </span>
                        </a>

                        <img src="{{asset("Shower Faucets.png")}}" alt="" />
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item">
                    <div class="picframe">
                        <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Shower glass door</span>
                                </span>
                            </span>
                        </a>

                        <img src="{{asset("Shower glass door.png")}}" alt="" />
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item">
                    <div class="picframe">
                        <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Toilet Seat</span>
                                </span>
                            </span>
                        </a>

                        <img src="{{asset("Toilet Seat.png")}}" alt="" />
                    </div>
                </div>
                <!-- close gallery item -->
                ...
                <div class="item">
                    <div class="picframe">
                        <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Vanity Lights</span>
                                </span>
                            </span>
                        </a>

                        <img src="{{asset("Vanity Lights.png")}}" alt="" />
                    </div>
                </div>
                <!-- close gallery item -->
                <!-- gallery item -->
                <div class="item">
                    <div class="picframe">
                        <a class="simple-ajax-popup-align-top" href="#">
                            <span class="overlay-v">
                                <span class="pf_text">
                                    <span class="project-name">Vanity</span>
                                </span>
                            </span>
                        </a>

                        <img src="{{asset("Vanity.png")}}" alt="" />
                    </div>
                </div>
                <!-- close gallery item -->
