        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title m-b-0">Add Testimonial</h3>
                    {{ Form::open([ 'route' => 'testimonials.store','class'=>'form-horizontal generalForm','enctype'=>'multipart/form-data']) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror"
                                   required autocomplete="name" value="{{ old('designation')}}" autofocus id="name">
                            @error('designation')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                            <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea name="comment" class="form-control @error('comment') is-invalid @enderror" id="" cols="30" rows="10">{{ old('comment')}}</textarea>
