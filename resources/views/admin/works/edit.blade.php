            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea name="meta_description" class="form-control  @error('meta_description') is-invalid @enderror" id="" cols="30" rows="10">{{ $work->meta_description}}</textarea>
                    ...
                    <div class="prices" style="margin-bottom: 15px;">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="form-group">
                                   ...
                                   <textarea class="form-control" name="description_b[]" required>{{$before->description}}</textarea>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            @foreach($work->images as $image)
                                <div class="col-sm-6">
                                    <img src="{{asset('uploads/work/'.$image->image)}}"  style="width:100%;" alt="Image is not found." />
                                    <?php $serviceId = $work->id; $imageId = $image->id?>
                                    <a href='{{ route('admin.delete-work-image',array($serviceId,$imageId)) }}' class='btn btn-danger btn-xs'>Remove</a>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <form action="{{ route('admin.saveWorkImages') }}"  file="true" enctype ='multipart/form-data' class ='dropzone' id ='imageUpload'>
                            {{ csrf_field() }}
                        </form>
                    </div>
                </div>
