...
<div style="background-color: #18191b">
    ...
    border: 5px solid #fbfbfb;position:relative;margin:0 auto;top:25px;left:0px;width:960px;height:480px;overflow:hidden;visibility:hidden;background-color:#24262e;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:240px;width:720px;height:480px;overflow:hidden;">
            <div>
                ...
                <img data-u="thumb" src="{{asset("slider/img/004-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/005.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/005-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/006.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/006-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/007.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/007-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/008.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/008-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/009.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/009-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/010.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/010-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/013.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/013-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/014.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/014-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/015.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/015-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/016.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/016-s99x66.jpg")}}" />
            </div>
            <div>
                <img data-u="image" src="{{asset("slider/img/017.jpg")}}" />
                <img data-u="thumb" src="{{asset("slider/img/017-s99x66.jpg")}}" />
            </div>
            <div>
                ...
                <div class="col-md-3">
                    <div class="row">
                        <div class="col-md-12 wow fadeInUp" data-wow-delay=".3s">
                           ...
                           <p><i class="fa fa-bed id-color"></i> &nbsp; 3 Bedrooms</p>
                           <p><i class="fa fa-shower id-color"></i> &nbsp; 2 Bathrooms</p>
                           <p><i class="fa fa-tv id-color"></i> &nbsp; 3 Launch</p>
                           <p><i class="fa fa-map-marker id-color"></i> &nbsp; Markham</p>
        ...
        <section id="section-welcome-14" class="no-top no-bottom sm-mt0">
            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center no-gutters wow fadeInUp" data-bgcolor="rgba(20,20,20,.9)">
                    ...
                    <div class="col-md-6 text-middle">
                        <div class="twentytwenty-container">
                            <img src="{{asset("theme/images/before-after/1b.jpg")}}" alt="" class="img-responsive" />
                            <img src="{{asset("theme/images/before-after/1a.jpg")}}" alt="" class="img-responsive" />
                        </div>
                    </div>
                ...
                <div class="row align-items-center no-gutters wow fadeInUp" data-bgcolor="rgba(20,20,20,.9)">
                    ...
                    <div class="col-md-6 text-middle">
                        <div class="twentytwenty-container">
                            <img src="{{asset("theme/images/before-after/2b.jpg")}}" alt="" class="img-responsive" />
                            <img src="{{asset("theme/images/before-after/2a.jpg")}}" alt="" class="img-responsive" />
                        </div>
                    </div>
