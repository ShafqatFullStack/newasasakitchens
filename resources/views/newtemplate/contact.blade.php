...
@section('meta')
		<title>Contact | ASASA Kitchens
</title>
		<meta name="description" content="Content For best Renovation and Remodelling services in Toronto, you can contact us at 647-956-1116 or visit our office at 307- 250 Consumers Rd Toronto, ON M2J 4V6">
...
<img class="anim"  src="{{ asset('newtemplate/asasa-kitchen/contact.jpg') }}">
			...
			<h2 class="wow fadeInRight" data-wow-delay=".5s" style="color:#fff">Contact us</h2>
				<p class="wow fadeInRight" data-wow-delay=".6s" style="color:#fff">We are here as ASASA Kitchen to help our clients and answer every question they ask about the project. Contact us today and book your appointment now.</p>
				<div class="linespace"></div>
				<a class="radius button button-primary button-shadow wow fadeInRight"  href="tel:{{ $setting['phone'] }}" style="margin-top:10%;">{{ $setting['phone'] }}</a>

			<a class="radius button button-primary button-shadow wow fadeInRight" href="{{route('about-us')}}" style="margin-top:10%;">About Us</a>
                    ...
                    <div class="row justify-content-around">
                        <div class="col-md-6">
                            <div class="contact-us-form gray-light-bg rounded p-5" style='background:#f6f6f6'>
                                ...
                                <form action="{{ route('contact-process') }}" method="post" class="  contact-form php-email-form">
			@csrf
              ...
              <div class="text-center"><button type="submit">Send Message</button></div>
                        ...
                        <div class="col-md-5">
                            <div class="contact-us-content">
                                <h2 style="color: initial;line-height: 1.21;font-weight: 600;margin: 0 0 1rem;font-family: Montserrat,sans-serif;">Looking for an excellent kitchen  renovation service for your project? </h2>
                                ...
                                <address>
                                    @isset($setting['address']){{ $setting['address']}}@endisset
                                </address>
                                <br>
                                <span>Phone: @isset($setting['phone']){{ $setting['phone']}}@endisset</span> <br>
                                <span>Email: <a href="mailto:@isset($setting['email']){{ $setting['email']}}@endisset" class="link-color">@isset($setting['email']){{ $setting['email']}}@endisset</a></span>
